      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by issue name or labels..."
              value={searchTerm}
              onChange={(e) => dispatch(setSearchTerm(e.target.value))}
              className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent w-full sm:w-80 text-gray-900 placeholder-gray-500 bg-white"
            />
          </div>
          ...
          <motion.button
            ...
            className={`flex items-center space-x-2 px-4 py-2 border rounded-lg transition-colors text-gray-700 ${
              showFilters
          ...
          <div className="flex items-center space-x-2">
            <select
              ...
              className="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-gray-500 focus:border-transparent text-gray-900 bg-white"
            >
